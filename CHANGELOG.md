...
- TTS/Matrix voice bubbles: add `"matrix"` to `VOICE_BUBBLE_CHANNELS` so TTS auto-replies on Matrix use Opus format with `voiceCompatible: true`, enabling native MSC3245 voice message bubbles instead of generic audio file attachments. (#37061)
