...
- Agents/tool result format: add `matrix` and `msteams` to `MARKDOWN_CAPABLE_CHANNELS` so tool results on these channels use markdown formatting instead of plain text.
