...
- Cron/file permissions: create `jobs.json`, `jobs.json.bak`, and `runs/*.jsonl` with mode `0600` (owner-only) instead of `0644`, preventing other OS users from reading cron schedules and job output on shared systems. (#35881)
